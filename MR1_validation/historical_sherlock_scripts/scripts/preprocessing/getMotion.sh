...
#
# Output: MR1/fd_qc/fd_summary.csv (one row per subject x run)
#
#SBATCH -J FD_QC_MR1
#SBATCH --output=/scratch/groups/fvlin/MIDUS/MR1/log/fd_qc_%A_%a.log
#SBATCH --error=/scratch/groups/fvlin/MIDUS/MR1/log/fd_qc_%A_%a.err
...
# Paths
confounds_dir = "/scratch/groups/fvlin/MIDUS/MR1/derivatives"
output_dir = "/scratch/groups/fvlin/MIDUS/MR1/fd_qc"
