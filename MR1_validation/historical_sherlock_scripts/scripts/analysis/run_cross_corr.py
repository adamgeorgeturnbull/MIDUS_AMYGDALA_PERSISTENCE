...
Output (in MR1/voxelwise_betas_summary/):
...
# ========== USER SETTINGS ==========
BASE_DIR = Path("/scratch/groups/fvlin/MIDUS/MR1/voxelwise_betas")
OUT_DIR  = Path("/scratch/groups/fvlin/MIDUS/MR1/voxelwise_betas_summary")
