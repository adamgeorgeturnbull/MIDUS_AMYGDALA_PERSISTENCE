...
Sensitivity analyses for Analysis 06: Persistence × ERQ → Affect.
...
Sections:
  ...
  2. Right hemisphere persistence     → sensitivity_right_hemisphere/reappraisal|suppression/
...
BASE_DIR   = RESULTS_DIR / "06_persistence_affect_moderation"
...
def main():
    ...
    for mod_var, mod_name in MODERATORS:
        ols_df, mlm_df = run_moderation_set(
            cons, "neg_persist_crossrun_mean_z_R",
            diary_outcomes, mod_var, base_covs,
        )
        save_moderation(ols_df, mlm_df,
