...
BASE_DIR   = RESULTS_DIR / "07_fc_affect_moderation"
PRIMARY_FC = "l_amyg-ant_vmPFC_neg_vs_neu"   # used for sample definition
...
# ============================================================================
# Moderation helpers (identical to primary script)
# ============================================================================
...
def main():
    print("=" * 70)
    print("Analysis 07 — Sensitivity Analyses")
    print("=" * 70)
    ...
    for mod_var, mod_name in MODERATORS:
        ols_df, mlm_df = run_moderation_set(
            panas_sample, panas_preds, panas_outcomes, mod_var, panas_covs,
        )
    ...
    if right_preds:
        for mod_var, mod_name in MODERATORS:
            ols_df, mlm_df = run_moderation_set(
                cons, right_preds, diary_outcomes, mod_var, base_covs,
            )
            save_moderation(ols_df, mlm_df,
